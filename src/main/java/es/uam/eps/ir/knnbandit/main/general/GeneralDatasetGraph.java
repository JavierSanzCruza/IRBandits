...
/**
 * Obtains the common items graph for domain-independent networks.
 ...
 */
public class GeneralDatasetGraph<U,I> extends DatasetGraph<U,I>
{
    /**
     ...
     */
    public GeneralDatasetGraph(String input, String separator, Parser<U> uParser, Parser<I> iParser, double threshold, boolean useRatings) throws IOException
    {
