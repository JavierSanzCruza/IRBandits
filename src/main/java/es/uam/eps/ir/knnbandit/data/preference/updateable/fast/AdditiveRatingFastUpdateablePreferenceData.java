 ...
 */
public class AdditiveRatingFastUpdateablePreferenceData<U, I> extends AbstractSimpleFastUpdateablePreferenceData<U,I>
{
    /**
     ...
     */
    protected AdditiveRatingFastUpdateablePreferenceData(int numPreferences, List<List<IdxPref>> uidxList, List<List<IdxPref>> iidxList,
                                                         FastUpdateableUserIndex<U> uIndex, FastUpdateableItemIndex<I> iIndex)
    {
        super(numPreferences, uidxList, iidxList, uIndex, iIndex, (x,y) -> true,
    ...
    {
        super(numPreferences, uidxList, iidxList, uIndex, iIndex, (x,y) -> true, uPrefFun, iPrefFun);
    }
     ...
     */
    public static <U, I> AdditiveRatingFastUpdateablePreferenceData<U, I> load(Stream<Tuple3<U, I, Double>> tuples, FastUpdateableUserIndex<U> uIndex, FastUpdateableItemIndex<I> iIndex)
    {
     ...
     * @return an instance of SimpleFastPreferenceData containing the data from the input stream.
     */
    public static <U, I, O> AdditiveRatingFastUpdateablePreferenceData<U, I> load(Stream<Tuple4<U, I, Double, O>> tuples,
                                                                                  ...
                                                                                  Function<IdxPref, IdPref<U>> iIdPrefFun)
    {
        ...
        return new AdditiveRatingFastUpdateablePreferenceData<>(numPreferences.intValue(), uidxList, iidxList, uIndex, iIndex, uIdPrefFun, iIdPrefFun);
    }
