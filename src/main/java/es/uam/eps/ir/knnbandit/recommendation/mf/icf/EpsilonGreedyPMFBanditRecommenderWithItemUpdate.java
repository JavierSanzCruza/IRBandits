 ...
 */
public class EpsilonGreedyPMFBanditRecommenderWithItemUpdate<U, I> extends PMFBanditRecommender<U, I>
{
    /**
     ...
     */
    public EpsilonGreedyPMFBanditRecommenderWithItemUpdate(FastUpdateableUserIndex<U> uIndex, FastUpdateableItemIndex<I> iIndex, SimpleFastPreferenceData<U, I> prefData, boolean hasRating, int k, double stdevP, double stdevQ, double stdev, int numIter, double epsilon)
    {
     ...
     * @param epsilon       Probability of recommending an item at random.
     */
    public EpsilonGreedyPMFBanditRecommenderWithItemUpdate(FastUpdateableUserIndex<U> uIndex, FastUpdateableItemIndex<I> iIndex, SimpleFastPreferenceData<U, I> prefData, boolean hasRating, boolean notReciprocal, int k, double stdevP, double stdevQ, double stdev, int numIter, double epsilon)
    {
