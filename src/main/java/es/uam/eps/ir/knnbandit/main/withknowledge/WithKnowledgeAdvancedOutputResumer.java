...
public class WithKnowledgeAdvancedOutputResumer<U,I> extends AdvancedOutputResumer<U,I>
{
     ...
     */
    public WithKnowledgeAdvancedOutputResumer(String input, String separator, Parser<U> uParser, Parser<I> iParser, double threshold, boolean useRatings) throws IOException
    {
