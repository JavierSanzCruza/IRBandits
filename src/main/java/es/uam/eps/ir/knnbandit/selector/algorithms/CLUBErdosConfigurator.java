...
/**
 * Class for configuring the CLUstering of Bandits algorithm using the Erdos user-user graph.
 *
 ...
 *
 * @see es.uam.eps.ir.knnbandit.recommendation.clusters.club.CLUBERdos
 */
public class CLUBErdosConfigurator<U,I> extends AbstractAlgorithmConfigurator<U,I>
{
     ...
     */
    private class CLUBErdosInteractiveRecommenderSupplier implements InteractiveRecommenderSupplier<U,I>
    {
        /**
