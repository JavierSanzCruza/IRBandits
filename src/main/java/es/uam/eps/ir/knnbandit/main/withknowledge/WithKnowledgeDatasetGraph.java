...
import es.uam.eps.ir.knnbandit.main.DatasetGraph;
 ...
 * about whether the user knew about the items.
 *
 ...
 */
public class WithKnowledgeDatasetGraph<U,I> extends DatasetGraph<U,I>
{
    /**
     ...
     */
    public WithKnowledgeDatasetGraph(String input, String separator, Parser<U> uParser, Parser<I> iParser, double threshold, boolean useRatings, KnowledgeDataUse dataUse) throws IOException
    {
