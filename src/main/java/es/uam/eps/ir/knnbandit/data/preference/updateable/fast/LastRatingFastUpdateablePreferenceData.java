 ...
 */
public class LastRatingFastUpdateablePreferenceData<U, I> extends AbstractSimpleFastUpdateablePreferenceData<U,I>
{
    /**
     ...
     */
    protected LastRatingFastUpdateablePreferenceData(int numPreferences, List<List<IdxPref>> uidxList, List<List<IdxPref>> iidxList,
                                                     FastUpdateableUserIndex<U> uIndex, FastUpdateableItemIndex<I> iIndex)
    {
        super(numPreferences, uidxList, iidxList, uIndex, iIndex, (x,y) -> !x.equals(y),
    ...
    {
        super(numPreferences, uidxList, iidxList, uIndex, iIndex, (x,y) -> !x.equals(y), uPrefFun, iPrefFun);
    }
     ...
     */
    public static <U, I> LastRatingFastUpdateablePreferenceData<U, I> load(Stream<Tuple3<U, I, Double>> tuples, FastUpdateableUserIndex<U> uIndex, FastUpdateableItemIndex<I> iIndex)
    {
     ...
     * @return an instance of SimpleFastPreferenceData containing the data from the input stream.
     */
    public static <U, I, O> LastRatingFastUpdateablePreferenceData<U, I> load(Stream<Tuple4<U, I, Double, O>> tuples,
                                                                              ...
                                                                              Function<IdxPref, IdPref<U>> iIdPrefFun)
    {
        ...
        tuples.forEach(t ->
        {
            ...
            if(uidxVisited.get(uidx).containsKey(iidx))
            {
                ...
                uList.set(uidxIndex, uIdxPrefFun.apply(uidx, iidx, t.v3, t.v4));

                int iidxIndex = iidxVisited.get(iidx).get(uidx);
                List<IdxPref> iList = iidxList.get(iidx);
                iList.set(iidxIndex, iIdxPrefFun.apply(uidx, iidx, t.v3, t.v4));
            }
            else
            {
        ...
        return new LastRatingFastUpdateablePreferenceData<>(numPreferences.intValue(), uidxList, iidxList, uIndex, iIndex, uIdPrefFun, iIdPrefFun);
    }
