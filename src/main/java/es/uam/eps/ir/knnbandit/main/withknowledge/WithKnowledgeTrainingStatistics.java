 ...
 * recommendation data, with knowledge about whether the user knew about the items
...
public class WithKnowledgeTrainingStatistics<U,I> extends TrainingStatistics<U,I>
{
     ...
     */
    public WithKnowledgeTrainingStatistics(String input, String separator, Parser<U> uParser, Parser<I> iParser, double threshold, boolean useRatings, IOSelector warmupIoSelector) throws IOException
    {
