...
/**
 * Obtains the common items graph for contact recommendation datasets.
 * @param <U> type of the users.
 *
 * @author Javier Sanz-Cruzado (javier.sanz-cruzado@uam.es)
 * @author Pablo Castells (pablo.castells@uam.es)
 */
public class ContactDatasetGraph<U> extends DatasetGraph<U,U>
{
    /**
     ...
     */
    public ContactDatasetGraph(String input, String separator, Parser<U> parser, boolean directed, boolean notReciprocal)
    {
