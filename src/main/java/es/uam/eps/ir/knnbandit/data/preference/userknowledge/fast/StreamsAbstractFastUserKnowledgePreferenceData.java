 ...
 */
public abstract class StreamsAbstractFastUserKnowledgePreferenceData<U, I> extends AbstractFastUserKnowledgePreferenceData<U, I>
{
    /**
     ...
     */
    public StreamsAbstractFastUserKnowledgePreferenceData(FastUserIndex<U> userIndex, FastItemIndex<I> itemIndex)
    {
     ...
     */
    public StreamsAbstractFastUserKnowledgePreferenceData(FastUserIndex<U> userIndex, FastItemIndex<I> itemIndex, Function<IdxPref, IdPref<I>> uPrefFun, Function<IdxPref, IdPref<U>> iPrefFun)
    {
    ...
    {
        return new StreamDoubleIterator(getUidxKnownPreferences(uidx).mapToDouble(IdxPref::v2));
    }

    @Override
    public IntIterator getUidxKnownIidxs(int uidx)
    {
        return new StreamIntIterator(getUidxKnownPreferences(uidx).mapToInt(IdxPref::v1));
    }

    @Override
    public DoubleIterator getUidxUnknownVs(int uidx)
    {
        return new StreamDoubleIterator(getUidxUnknownPreferences(uidx).mapToDouble(IdxPref::v2));
    }

    @Override
    public IntIterator getUidxUnknownIidxs(int uidx)
    {
        return new StreamIntIterator(getUidxUnknownPreferences(uidx).mapToInt(IdxPref::v1));
    }

    @Override
    public DoubleIterator getIidxKnownVs(int iidx)
    {
        return new StreamDoubleIterator(getIidxKnownPreferences(iidx).mapToDouble(IdxPref::v2));
    }

    @Override
    public IntIterator getIidxKnownUidxs(int iidx)
    {
        return new StreamIntIterator(getIidxKnownPreferences(iidx).mapToInt(IdxPref::v1));
    }

    @Override
    public DoubleIterator getIidxUnknownVs(int iidx)
    {
        return new StreamDoubleIterator(getIidxUnknownPreferences(iidx).mapToDouble(IdxPref::v2));
    }

    @Override
    public IntIterator getIidxUnknownUidxs(int iidx)
    {
        return new StreamIntIterator(getIidxUnknownPreferences(iidx).mapToInt(IdxPref::v1));
    }
