...
public class GeneralAdvancedOutputResumer<U,I> extends AdvancedOutputResumer<U,I>
{
     ...
     */
    public GeneralAdvancedOutputResumer(String input, String separator, Parser<U> uParser, Parser<I> iParser, double threshold, boolean useRatings, IOSelector ioSelector) throws IOException
    {
        super(ioSelector);
