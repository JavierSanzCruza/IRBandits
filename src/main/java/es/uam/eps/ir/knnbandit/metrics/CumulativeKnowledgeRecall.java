 ...
 */
public class CumulativeKnowledgeRecall<U, I> implements CumulativeMetric<U, I>
{
    /**
     ...
     * Constructor.
     */
    public CumulativeKnowledgeRecall(KnowledgeDataUse dataUse)
    {
        this.current = 0.0;
        this.toRemove = 0;
    ...
    public void initialize(Dataset<U,I> dataset)
    {
        ...
        this.numRel = this.dataset.getNumRel();
    ...
    {
        if(relevance.test(value) && this.dataset.getPreference(uidx, iidx).isPresent()) this.current++;
    }
