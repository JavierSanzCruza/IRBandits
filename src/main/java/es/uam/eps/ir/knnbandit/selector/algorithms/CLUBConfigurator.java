...
/**
 * Class for configuring the CLUstering of Bandits algorithm using the complete user-user graph.
 *
 ...
 *
 * @see es.uam.eps.ir.knnbandit.recommendation.clusters.club.CLUBComplete
 */
public class CLUBConfigurator<U,I> extends AbstractAlgorithmConfigurator<U,I>
{
    ...
    /**
     * Identifier for the parameter that manages how difficult is for an edge in the graph to disappear.
     */
    ...
    /**
     * Class that configures CLUB recommender.
     */
    private class CLUBInteractiveRecommenderSupplier implements InteractiveRecommenderSupplier<U,I>
    {
        /**
