 ...
 */
public class DelayedThompsonSamplingItemBandit extends AbstractMultiArmedBandit
{
    /**
     ...
     */
    public DelayedThompsonSamplingItemBandit(int numArms, int delay)
    {
        super(numArms);
     ...
     */
    public DelayedThompsonSamplingItemBandit(int numArms, double initialAlpha, double initialBeta, int delay)
    {
        super(numArms);
        this.betas = new BetaDistribution[numArms];
        this.delays = new Int2IntOpenHashMap();
     ...
     */
    public DelayedThompsonSamplingItemBandit(int numArms, double[] initialAlphas, double[] initialBetas, int delay)
    {
        super(numArms);
        this.betas = new BetaDistribution[numArms];
        this.delays = new Int2IntOpenHashMap();
