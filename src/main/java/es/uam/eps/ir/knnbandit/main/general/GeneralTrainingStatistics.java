...
public class GeneralTrainingStatistics<U,I> extends TrainingStatistics<U,I>
{
     ...
     */
    public GeneralTrainingStatistics(String input, String separator, Parser<U> uParser, Parser<I> iParser, double threshold, boolean useRatings) throws IOException
    {
