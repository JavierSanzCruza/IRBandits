...
/**
 * Given a Foursquare dataset, finds an undirected and weighted one indicating the existence of common rated (relevant) items.
 *
...
public class DatasetGraph
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        PreferenceData<Long, String> prefData = dataset.getPrefData();
